...
@interface CarouseView()<UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
...
//
//         UIViewAnimationTransitionFlipFromRight forView: _scrollView cache:NO];
...
//        [UIView setAnimationTransition:
//
//         UIViewAnimationTransitionFlipFromLeft forView: _scrollView cache:NO];
//
//    [self changePageLeft];
//
    [self resetPageIndex:NO ];
